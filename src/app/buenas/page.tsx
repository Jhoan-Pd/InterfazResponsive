...
export default function BuenasPracticasPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br bg-stone-200 to-stone-400 p-6">
      <motion.div
      ...
      >
        ...
        <ul className="space-y-4">
          {practicas.map((item, index) => (
            ...
            >
              <CheckCircle className="text-green-300 w-6 h-6 mr-3 bg-slate-400" />
